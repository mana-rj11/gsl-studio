...
export default function Home() {
  return (
    <div>
      {/* Hero */}
      <section className="min-h-screen flex flex-col items-center justify-center text-center px-6 bg-gsl-dark">
        <Image src="/logo-light.png" alt="GSL Studio" width={300} height={100} className="mb-8" />
      ...
      <section className="py-20 px-6 bg-gsl-brown text-center">
        <h2 className="text-3xl font-bold mb-4">Rejoins l&apos;aventure</h2>
